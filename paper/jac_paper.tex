...
The Zillow neighborhood boundaries \url{http://www.zillow.com/howto/api/neighborhood-boundaries.htm}

Each Zillow neighborhood has geographic boundaries, defined in an associated ESRI arcGIS shape file. Boundary information \url{http://www.zillowgroup.com/news/7000-neighborhood-boundary-files-in-shapefile-format/} Released in 2008

ZHVI methodology. \url{http://www.zillow.com/research/zhvi-methodology-6032/} \citep{dorsey2010hedonic}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{number_cutoff_2.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{neighborhood_cutoff_state.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{neighborhood_cutoff_state2.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{all_review_trend.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{all_review_trend_detail.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{state_review_trend.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{state_review_trend_log.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{review_neighborhood_hist.png}
\caption{}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{review_business_hist.png}
\caption{}
\label{review_business_hist}
\end{center}
\end{figure}

\subsection{Yelp User Description} \label{Yelp User Description}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = \textwidth]{stars_price_scatter_metro.png}
\caption{}
